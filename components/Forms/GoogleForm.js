...
const GoogleForm = () => {
	return (
		<div className="sm:py-6 w-full pb-12 flex flex-col h-full flex-shrink-0 flex-grow mx-0 ">
			<div className="bg-gray-100">
					...
					<div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8">
						<div className="text-center">
							...
							<p className="mt-4 text-xl leading-7 text-gray-500">
								Estamos en la versión Beta, así que presiona el botón de abajo para agregar tu
								propiedad a la página.
							</p>
						</div>
					</div>
				</div>
				<div className="mt-8 bg-white pb-16 sm:mt-12 sm:pb-20 lg:pb-28">
					<div className="relative">
						...
						<div className="relative max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8">
							<div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
								<div className="bg-white px-6 py-8 lg:flex-shrink-1 lg:p-12">
									...
									<p className="mt-6 text-base leading-6 text-gray-500">
										Si eres un agente representando una propiedad los clientes potenciales
										de esta página te llegarán directamente. Ningún otro agente podrá
										agregar la misma propiedad.
									</p>
									<div className="mt-8">
										...
										<ul className="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
											<li className="flex items-start lg:col-span-1">
												...
												<p className="ml-3 text-sm leading-5 text-gray-700">
													Acceso directo a todos los clientes potenciales.
												</p>
											</li>
											<li className="mt-5 flex items-start lg:col-span-1 lg:mt-0">
												...
												<p className="ml-3 text-sm leading-5 text-gray-700">
													Exclusividad en tus propiedades.
												</p>
											</li>
											<li className="mt-5 flex items-start lg:col-span-1 lg:mt-0">
												<div className="flex-shrink-0">
								...
								<div className="py-8 px-6 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
									<div className="mt-6">
										<div className="rounded-md shadow">
											<a
												href="https://docs.google.com/forms/d/e/1FAIpQLSe5YcRkyrsFrSp-8n2tPc3Wx5ukYrJ8PFm0t3aiN6gZXKdOOQ/viewform?usp=sf_link"
												target="_blank"
