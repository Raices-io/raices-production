...
export default React.memo(({ home, setSelectedHome, setAddTourLinkModal }) => {
	const handleClick = clickedHome => {
		setAddTourLinkModal(true);
	...
	return (
		<li>
			<div
				className="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out m-2 bg-white shadow-sm rounded-lg cursor-pointer"
